...
class thread implements Runnable {
    public void run() {
        ...
        System.out.println(  "State of thread1 while it called join() method on thread2 -" + LifecycleAndStates.thread1.getState());
        try {
            Thread.sleep(200);
        }catch (InterruptedException e) {
            e.printStackTrace();
...
public class LifecycleAndStates implements Runnable {
    public static Thread thread1;
    public static LifecycleAndStates obj;

    public static void main(String[] args) {
        obj = new LifecycleAndStates();
    ...
    public void run() {
        ...
        try {
            Thread.sleep(200); // moving thread1 to timed waiting state
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
