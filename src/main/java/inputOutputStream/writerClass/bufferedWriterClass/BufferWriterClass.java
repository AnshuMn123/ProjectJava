package inputOutputStream.writerClass.bufferedWriterClass;
...
public class BufferWriterClass {
    public static void main(String[] args) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("/home/asingh/codebase/ProjectJava/src/main/java/inputOutputStream/writerClass/bufferedWriterClass/file.txt"));

        //or
        BufferedWriter bw1 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("/home/asingh/codebase/ProjectJava/src/main/java/inputOutputStream/writerClass/bufferedWriterClass/file.txt")));
